...
fn test_update_agent_input_default() {
    let _input = agent_management::service::agent::UpdateAgentInput::default();
}

// Test that UpdateAgentInput can be constructed with some fields
#[test]
fn test_update_agent_input_partial() {
    let _input = agent_management::service::agent::UpdateAgentInput {
...
fn test_agent_filters_default() {
    let _filters = agent_management::service::agent::AgentFilters::default();
}

// Test that AgentFilters can be constructed with filters
#[test]
fn test_agent_filters_with_values() {
    let _filters = agent_management::service::agent::AgentFilters {
        status: Some("connected".to_string()),
...
fn test_agent_service_default_panics() {
    ...
    let _ = agent_management::service::agent::AgentService::default();
}
