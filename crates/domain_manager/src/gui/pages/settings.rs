...
use crate::gui::handlers::message_handler::{
    MessageCategory, NotificationMessage, UiMessage, WindowMessage,
};
...
use iced::widget::{text, Button, Column, Container, Row, Slider};
...
) -> Element<'static, MessageCategory, StyleType> {
...
fn appearance_settings<'a>(
    ...
    let opacity_section = Column::new()
        ...
        .push(
            Slider::new(0.0..=1.0, background_config.opacity, |opacity| {
                MessageCategory::Window(WindowMessage::BackgroundOpacityChange(opacity))
            })
            .step(0.01)
    ...
    let theme_section = Column::new()
        .spacing(10)
        .push(text(get_text("settings.theme")).size(16).font(font))
        .push(
            Button::new(
                Row::new()
                    .spacing(8)
                    .align_y(Alignment::Center)
                    .push(Icon::HalfSun.to_text().size(16).align_y(Alignment::Center))
                    .push(text(get_text("settings.toggle_theme")).font(font)),
            )
            .on_press(MessageCategory::Ui(UiMessage::ToggleTheme))
...
fn background_type_button(
    ...
    label: String,
    font: Font,
) -> Button<'static, MessageCategory, StyleType> {
    let is_selected = background_type == current_type;

    Button::new(text(label).font(font).align_x(Alignment::Center))
                ...
                .push(
                    Button::new(
                        Row::new()
                            .spacing(8)
                            .align_y(Alignment::Center)
                            .push(Icon::Bell.to_text().size(16).align_y(Alignment::Center))
                            .push(text(get_text("settings.enable_notifications")).font(font)),
                    )
                    .on_press(MessageCategory::Notification(
                        NotificationMessage::ShowToast(get_text("feature_under_development")),
                    ))
                    .class(ButtonType::Standard),
                )
                .push(
                    Button::new(
                        Row::new()
                            .spacing(8)
                            .align_y(Alignment::Center)
                            .push(Icon::Settings.to_text().size(16).align_y(Alignment::Center))
                ...
                .push(
                    Button::new(
                        Row::new()
                            .spacing(8)
                            .align_y(Alignment::Center)
                            .push(Icon::Language.to_text().size(16).align_y(Alignment::Center))
                ...
                .push(
                    Button::new(
                        Row::new()
                            .spacing(8)
                            .align_y(Alignment::Center)
                            .push(Icon::Update.to_text().size(16).align_y(Alignment::Center))
                ...
                .push(
                    Button::new(
                        Row::new()
                            .spacing(8)
                            .align_y(Alignment::Center)
                            .push(Icon::Export.to_text().size(16).align_y(Alignment::Center))
                ...
                .push(
                    Button::new(
                        Row::new()
                            .spacing(8)
                            .align_y(Alignment::Center)
                            .push(Icon::Import.to_text().size(16).align_y(Alignment::Center))
