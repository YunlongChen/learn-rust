...
use iced::widget::{svg, Container, Svg};
    ...
    fn get_background_path(&self) -> Option<String> {
        match self.background_type {
            ...
            BackgroundType::ChinaRed => {
                Some("resources/backgrounds/china_red_background.svg".to_string())
            }
            BackgroundType::QipaoGirl => {
                Some("resources/backgrounds/qipao_girl_background.svg".to_string())
            }
        }
    }
